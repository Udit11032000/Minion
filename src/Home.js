...
import image from "./images/clipart1287470.png"
  ...
  return (
        ...
        <div class="minion-svg">
            <ReactBootStrap.Row>
                ...
                <ReactBootStrap.Col sm className="col-minion"><h1 class="minion-bello">bello!</h1><p className="paragraph">Humans! How Are you?</p></ReactBootStrap.Col>
                <ReactBootStrap.Col sm className="col-minion">
                <img class="image-dimension-two" src={image} alt="image"/>
                </ReactBootStrap.Col>
